...
const EditEmployeeDialog = ({ open, onClose, onSuccess, employee, teams }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await axiosInstance.put(`/employees/${employee._id}`, formData);
      ...
      setErrors({
        submit: err?.response?.data?.message || "Failed to update employee",
      });
    } finally {
      setLoading(false);
    }
